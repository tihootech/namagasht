		...
		<div class="tab-pane fade @if($page=='table') active show @endif" id="table">
			...
			<div class="table-responsive p-2 p-md-5">
				...
				<div class="text-left">
					...
					<a href="{{url("form/excel/$form->id")}}" class="btn btn-success mx-1 px-3" data-toggle="popover" data-content="{{__('words.EXCEL_OUTPUT')}}" data-placement="top" data-trigger="hover">
				...
				@include('forms.partials.form_report')
